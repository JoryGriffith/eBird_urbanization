...
# load whole dataset
ebd <- auk_ebd("/Volumes/Backup/eBird/ebd_relMar-2023/ebd_relMar-2023.txt")
  #             file_sampling = "ebd_sampling_relOct-2022/ebd_sampling_relOct-2022.txt")

years <- c(2017, 2018, 2019, 2020, 2021, 2022)
output_files <- c("/Volumes/Backup/eBird/eBird_2017_data/ebd_2017.txt", "/Volumes/Backup/eBird/eBird_2018_data/ebd_2018.txt", 
                  "/Volumes/Backup/eBird/eBird_2019_data/ebd_2019.txt", "/Volumes/Backup/eBird/eBird_2020_data/ebd_2020.txt",
                  "/Volumes/Backup/eBird/eBird_2021_data/ebd_2021.txt", "/Volumes/Backup/eBird/eBird_2022_data/ebd_2022.txt")
