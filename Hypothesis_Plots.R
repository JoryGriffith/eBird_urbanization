...
summer.plot <- ggplot(dat, aes(x=x, y=y))+
  ...
  geom_abline(slope=-0.9, intercept=206, color="#CC79A7", linewidth=1.2) +
  geom_abline(slope=-0.2, intercept=115, color="#000000", linewidth=1.2) +
  scale_x_continuous(expand=c(0,0))+
  scale_y_continuous(limits=c(0,500), expand=c(0,0))+
  labs(x="Absolute Latitude", y="Species Richness") +
  theme_classic() +
...
p1.plot <- ggplot(dat, aes(x=x, y=y))+
  ...
  labs(x="Absolute Latitude", y="Proportion") +
  scale_x_continuous(expand=c(0,0))+
...
p3.summer <- ggplot(dat, aes(x=x, y=y))+
  geom_point(alpha=0)+
  geom_abline(aes(slope=0, intercept=1, color="Natural"), linewidth=1.5, lty=2) +
...
p3.winter <- ggplot(dat, aes(x=x, y=y))+
  geom_point(alpha=0)+
  geom_abline(aes(slope=0, intercept=1, color="Natural"), linewidth=1.5, lty=2) +
...
ggsave(p3.winter, file="hypothesis_figs/proportionH3wint.plot.png", height=3, width=3)
...
hypothesis.plot2
ggsave(hypothesis.plot2, file="hypothesis_figs/hypothesis.plot.png", height=8, width=9)
